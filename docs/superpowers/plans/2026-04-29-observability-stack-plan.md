...
- [x] **Step 3: Commit `feat(obs): 5 条 critical 告警`**
...
- [x] **Step 2: 校验**
- [x] **Step 3: Commit `feat(obs): 11 条 warning 告警`**
...
- [x] **Step 2: Commit `feat(obs): SLO 错误预算燃烧率告警（1h+6h 双窗口）`**
...
- [x] **Step 1: 撰文 — 来源 spec §9 + 实际 yml**
  ...
  - 客户视角："为什么这些数字是合同里写的？"
- [x] **Step 2: 索引联动**
- [x] **Step 3: Commit `docs(obs): SLO + 告警规则参考（Phase D 落实）`**
